...
Report problems to rt-other@ccbb.utexas.edu''')
    ...
    optional.add_argument('-a', action='store', dest='allocation', nargs='?', default=env_allocation, help='The TACC allocation for job submission. You can set a default ALLOCATION environment variable.')
    optional.add_argument('-m', action='store', dest='modules', default='', help='A list of module commands. The "launcher" module is always automatically included.')
